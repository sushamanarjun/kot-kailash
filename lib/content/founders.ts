...
export const founders: Founder[] = [
  {
    id: 'pushkar',
    role: 'Custodian of the Terrain',
    name: 'Pushkar Singh Negi',
    subtitle: 'Custodian of the Terrain',
    bio: [
  ...
  {
    id: 'sayed',
    role: 'Architect of the Vision',
    name: 'Sayed Aziz',
    subtitle: 'Architect of the Vision',
    bio: [
      ...
      'He subsequently joined one of the world\'s most iconic automotive brands, building the company\'s global travel, administration and events infrastructure, representing the brand at international motorcycle launches across multiple continents, and working alongside design and architecture teams on the greenfield development of the company\'s global headquarters. He later moved to London, where he manages executive operations and private estates at the most senior level of the organisation.',
